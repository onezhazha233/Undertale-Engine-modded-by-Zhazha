...
if(_menu==0){
	...
	if(_mode==0){
		...
		_inst_instruction.text=_prefix+"{color_text `ligray`} --- Instruction ---{space_y -1}&&{space_y 2}[Z or ENTER] - Confirm&[X or SHIFT] - Cancel&[C or CTRL] - Menu (In-game)&[F4] - Fullscreen&[Hold ESC] - Quit&When HP is 0, you lose.";
