...
draw_text_ext_transformed(32+6+8,52+(_top ? 270 : 0)+6+42-6,"LV  "+string(Player_GetLv())+"\nHP  "+string(Player_GetHp())+"/"+string(Player_GetHpMax())+"\nG   ",9,-1,2,2,0);
draw_text_ext_transformed(32+6+8+36,52+(_top ? 270 : 0)+6+42-6+37,string(Player_GetGold()),9,-1,2,2,0);
